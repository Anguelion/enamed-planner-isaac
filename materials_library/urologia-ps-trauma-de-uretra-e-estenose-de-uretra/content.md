...
**Resumo do trauma de uretra**

| Item | Uretra Anterior (peniana + bulbar) | Uretra Posterior (prostática + membranosa) |
|---|---|---|
...
Figura 1: Topografia e divisões da uretra (posterior: prostática, membranosa; anterior: bulbar, peniana).
...
- **Uretrocistografia retrógrada e miccional (padrão-ouro):**
  ...
  - Fase miccional: ocorre maior abertura do colo vesical, preenchendo melhor a uretra prostática.
...
Figura 6: Fluxograma do manejo do trauma de uretra — uretrocistografia retrógrada / uretrocistoscopia: se contuso → cistostomia/realinhamento endoscópico → reavaliação para tratamento definitivo; se penetrante ou fratura peniana → reparo primário.
...
- Enxerto de mucosa oral é uma opção na Balanite Xerótica Obliterante.

### Uretra Peniana

- Uretroplastia substitutiva, na qual há importante papel do enxerto de mucosa oral;
- Dilatação uretral;
...
- Se houver dificuldade na conexão da anastomose, pode-se lançar mão das Manobras de Webster:
  1. Liberação da uretra até o ligamento suspensor do pênis;
...
Figura 1: Ramanathan, S., Raghu, V. & Ramchandani, P. Imaging of the adult male urethra, penile prostheses and artificial urinary sphincters. Abdom Radiol 45, 2018–2035 (2020). https://doi.org/10.1007/s00261-019-02356-x

Figura 3: Uretrocistografia miccional com melhora da estenose apresentada em fase miccional. Ramanathan, S., Raghu, V. & Ramchandani, P. Imaging of the adult male urethra, penile prostheses and artificial urinary sphincters. Abdom Radiol 45, 2018–2035 (2020). https://doi.org/10.1007/s00261-019-02356-x

Figura 4: Extravasamento de contraste em uretra anterior em uretrocistografia miccional. Radswiki T, Urethral rupture. Case study, Radiopaedia.org (Accessed on 02 Apr 2025) https://doi.org/10.53347/rID-12058

Figura 5: Extravasamento de contraste em uretrocistografia miccional. Dixon A, Traumatic urethral injury. Case study, Radiopaedia.org (Accessed on 02 Apr 2025) https://doi.org/10.53347/rID-31648

Figura 7: Balanite Xerótica Obliterante. Depasquale, I et al. "The treatment of balanitis xerotica obliterans." BJU international vol. 86,4 (2000): 459-65. doi:10.1046/j.1464-410x.2000.00772.x
