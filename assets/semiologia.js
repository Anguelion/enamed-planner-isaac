...
(function () {
  ...
  const CORPO_SINAIS = [
    ...
    { id: 'edema', nome: 'Edema de MMII (cacifo)', cat: 'Palpação', x: 96, y: 405,
    ...
    { id: 'hepatomegalia', nome: 'Hepatomegalia', cat: 'Palpação', view: 'ant', x: 92, y: 196,
    ...
    { id: 'esplenomegalia', nome: 'Esplenomegalia', cat: 'Palpação', view: 'ant', x: 128, y: 196,
    ...
    { id: 'tvp-panturrilha', nome: 'Sinais de TVP (panturrilha)', cat: 'Palpação', view: 'ant', x: 126, y: 362,
