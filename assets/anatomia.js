(function(root){
  ...
  function readerView(data, article, html){
    ...
    return `${topbar(data)}<div class="anat-reader-shell">
      ...
      </main></div>${ui.lightbox ? `<div class="anat-lightbox" data-anat-close-lightbox><button type="button" aria-label="Fechar">×</button><img src="${esc(ui.lightbox)}" alt="Imagem anatômica ampliada"></div>` : ''}`;
  }
