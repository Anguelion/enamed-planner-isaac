(function(root,factory){
  ...
  const ROUTE_TABS=new Set(['painel','cronograma','pendencias','aulas','questoes','analise','flashcards','materiais','simulados','prescricao','areas','historico','feynman','importar-questoes','ferramentas','caderno-erros','ecg','radiografia','semiologia','anatomia']);
  ...
  function validateQuestionRecord(question={}){
    ...
    if(!answer && !question.answerPending) reasons.push('Gabarito ausente.');
