...
function renderRadiografia() {
  document.getElementById('radiografia').innerHTML = `<section class="card"><div class="section-title"><div><span class="eyebrow">Em construção</span><h2>Radiografia</h2></div></div><p class="muted">Essa aba vai reunir prática de interpretação de radiografias. O conteúdo ainda não foi adicionado — a mecânica é definida numa conversa dedicada, depois que o material estiver disponível.</p></section>`;
}
