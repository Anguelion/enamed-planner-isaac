      ...
      topicos: [
        ...
        },
        {
          ...
          blocks: [
            ...
            F('complementos/redistribuicao-vascular-cefalizacao.webp', 'Redistribuição vascular ou cefalização do fluxo pulmonar: comparação mostrando vasos dos campos superiores mais calibrosos e evidentes após o aumento da pressão venosa pulmonar.'),
      ...
      topicos: [
        ...
        },
        {
          ...
          blocks: [
            ...
            F('complementos/triade-beck-pulso-paradoxal.webp', 'Tamponamento cardíaco: tríade de Beck (hipotensão, turgência jugular e bulhas abafadas) e representação do pulso paradoxal, com queda inspiratória da pressão arterial sistólica superior a 10 mmHg.'),
      ...
      topicos: [
        {
          ...
          blocks: [
            ...
            F('complementos/blumberg-murphy.webp', 'Manobras de Blumberg (dor à descompressão brusca, indicando irritação peritoneal) e Murphy (dor com interrupção da inspiração durante a palpação do hipocôndrio direito, sugerindo colecistite).'),
            F('complementos/cullen-grey-turner.webp', 'Sinais de Cullen e Grey-Turner: equimose periumbilical e equimose nos flancos, respectivamente — marcadores de sangramento intra-abdominal ou retroperitoneal.'),
        ...
        },
        {
          ...
          blocks: [
            ...
            F('complementos/grao-cafe-volvo-sigmoide.webp', 'Sinal do grão de café no volvo de sigmoide: alça colônica muito distendida em U invertido, com as paredes mediais justapostas formando a fenda central.'),
            ...
            F('complementos/grao-cafe-invertido-volvo-ceco.webp', 'Sinal do grão de café invertido ou da bola de futebol americano no volvo de ceco: o ceco dilatado desloca-se para o centro ou quadrante superior esquerdo.'),
        ...
        },
        {
          ...
          blocks: [
            ...
            F('complementos/rigler-dupla-parede.webp', 'Sinal de Rigler ou da dupla parede: ar dentro da alça e também livre na cavidade peritoneal torna visíveis as duas faces da parede intestinal.'),
            F('complementos/ligamento-falciforme.webp', 'Sinal do ligamento falciforme: o ar livre intraperitoneal delineia o ligamento, que passa a aparecer como uma linha de partes moles no abdome.'),
            F('complementos/chilaiditi.webp', 'Sinal de Chilaiditi: interposição de alça colônica entre o fígado e o diafragma, com haustrações visíveis — importante diferencial de pneumoperitônio.'),
      ...
      topicos: [
        ...
        },
        {
          ...
          blocks: [
            ...
            F('complementos/sinal-giordano.webp', 'Sinal de Giordano: dor desencadeada pela punho-percussão do ângulo costovertebral, sugestiva de acometimento renal, especialmente pielonefrite no contexto clínico adequado.'),
      ...
      topicos: [
        ...
        },
        {
          ...
          blocks: [
            ...
            F('complementos/fratura-base-cranio-sinais.webp', 'Sinais clínicos de fratura da base do crânio: equimose retroauricular (Battle), equimose periorbitária bilateral (olhos de guaxinim), hemotímpano e saída de líquor pelo nariz ou ouvido.'),
        ...
        },
        {
          ...
          blocks: [
            ...
            F('complementos/classificacao-visual-fraturas.webp', 'Classificação visual das fraturas: integridade (completa ou incompleta), direção do traço, relação com a articulação e tipos de desvio — angulação, translação, encurtamento e rotação.'),
          ],
        },
      ],
    },
      ...
      topicos: [
        ...
        },
        {
          ...
          blocks: [
            ...
            F('complementos/sindrome-horner.webp', 'Síndrome de Horner: ptose discreta, miose e anidrose facial ipsilaterais, combinação que deve levantar suspeita de dissecção carotídea no contexto de cefaleia ou cervicalgia aguda.'),
            ...
            F('complementos/papiledema.webp', 'Papiledema à fundoscopia: edema e elevação do disco óptico, hiperemia e apagamento de suas margens — sinal de hipertensão intracraniana.'),
        ...
        },
        {
          ...
          blocks: [
            ...
            F('complementos/avc-arteria-cerebral-media-hiperdensa.webp', 'Sinal da artéria cerebral média hiperdensa: segmento arterial mais branco que o esperado na TC sem contraste, correspondendo ao trombo agudo.'),
            F('complementos/avc-apagamento-nucleo-lentiforme.webp', 'Apagamento do núcleo lentiforme: perda precoce da definição dos núcleos da base no território isquêmico, comparada ao lado normal.'),
            F('complementos/avc-perda-faixa-insular.webp', 'Perda da faixa insular: desaparecimento da interface habitual entre o córtex insular e a substância branca adjacente.'),
            F('complementos/avc-perda-diferenciacao-cortico-subcortical.webp', 'Perda da diferenciação córtico-subcortical: o córtex e a substância branca passam a apresentar densidades semelhantes por edema isquêmico.'),
            F('complementos/avc-apagamento-sulcos-cisternas.webp', 'Apagamento dos sulcos e cisternas: edema cerebral com redução dos espaços liquóricos, um sinal precoce de efeito expansivo isquêmico.'),
          ],
        },
        {
        ...
        },
        {
          ...
          blocks: [
            ...
            F('complementos/triade-cushing.webp', 'Tríade de Cushing: hipertensão arterial, bradicardia e irregularidade respiratória — resposta tardia e grave ao aumento da pressão intracraniana.'),
